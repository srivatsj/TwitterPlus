 ...
 */
public class UserFollowingsFragment extends UserFragment {

    private String cursor = "-1";

    public static UserFollowingsFragment newInstance(String userId){
        UserFollowingsFragment userFragment = new UserFollowingsFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        aUsers = new UserArrayAdapter(getActivity(), users, false);
        populateTimeline();
    }
    ...
    public void populateTimeline() {
        ...
        if(!Utils.isNetworkAvailable(getActivity()))
        {
            ...
            showProgressBar();
            client.getFollowingForUsers(userId, cursor, new JsonHttpResponseHandler() {
